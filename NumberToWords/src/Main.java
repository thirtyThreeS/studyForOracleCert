...
public class Main {
    ...
    public static void numberToWords(int number)
    {
        ...
        // Apparently the following logic works for the problem at hand. It was worded poorly IMHO with the answer being one String, yet, this has a new line after each and every word.
